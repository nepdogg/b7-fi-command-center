...
v0.20 update: Removed the global READ ONLY / Enable Editing header control. Normal Command Center controls are available immediately; shared editing permissions are intended to be governed by Microsoft Lists/SharePoint.
