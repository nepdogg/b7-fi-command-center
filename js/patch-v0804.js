/* B7 FI Command Center v0.80.4 — active-quarter identity + Live Status spacing polish. */
(function(){
'use strict';
window.VERSION='0.80.4';
...
function version(){const l=$('#appVersionLabel');if(l)l.textContent='B7 FI COMMAND CENTER V0.80.4';document.title='B7 FI Command Center v0.80.4'}
